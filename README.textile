...
The the httpClient reference must an instance of org.apache.http.client.HttpClient.
...
<bean name="akismet" class="ac.simons.akismet.Akismet">
	...
	<property name="apiKey" ref="YOUR_API_KEY" />
	<!-- The name of your blog or site -->
	<property name="apiConsumer" ref="YOUR_SITE" />
</bean>
</code></pre>